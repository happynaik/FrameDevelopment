...
public class GetExecutionDetails implements ITestListener, ISuiteListener {
	...
	private void printTestResults(ITestResult result) {
		...
		if (result.getThrowable() != null) {
			Reporter.log("Test Method Class Name>> " + result.getTestClass().getName() + " Test Status: " + status
					+ " Reason>> " + result.getThrowable().getMessage(), true);
			Reporter.log("Test Case Name>> " + result.getMethod().getMethodName() + " Test Status: " + status
					+ " Reason>> " + result.getThrowable().getMessage(), true);
